...
.. image:: https://img.shields.io/travis/ClimateImpactLab/python_boilerplate.svg
        :target: https://travis-ci.org/ClimateImpactLab/python_boilerplate
...
.. image:: https://pyup.io/repos/github/ClimateImpactLab/python_boilerplate/shield.svg
     :target: https://pyup.io/repos/github/ClimateImpactLab/python_boilerplate/
     :alt: Updates
...
2.  Execute the following commands in this directory:
    ...
    .. code-block:: bash
        ...
        git remote add origin git@github.com:ClimateImpactLab/python_boilerplate.git
...
3.  Set up automated testing, coverage, updates, and docs:
    ...
    a.  Set up testing
        ...
        iii.    Flip the switch on ClimateImpactLab/python_boilerplate. If
        ...
        v.      Start writing tests for your code in the 
                ``python_boilerplate/tests`` folder. There are some
    ...
    b.  Set up docs
        ...
        iii.    click the '+' icon next to
                ClimateImpactLab/python_boilerplate. Pick a name for your
        ...
        iv.     next time you push code to master, docs should build
                ...
                https://python_boilerplate.readthedocs.io/en/latest/
    ...
    c.  Set up updates
        ...
        iii.    Add ClimateImpactLab/python_boilerplate
